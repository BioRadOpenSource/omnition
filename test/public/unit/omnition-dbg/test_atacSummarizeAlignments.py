...
spec = importlib.util.spec_from_file_location("summarize", "bin/publicAtacSummarizeAlignments.py")
...
def test_parse_flagstat():
	...
	flagstat_file = "test/public/unit/omnition-dbg/files/DemoAtacNormal_S1_flagstat.txt"
...
def test_bam_count():
	...
	test_bam = "test/public/unit/omnition-dbg/files/feature_aware_test.bam"
	contig = "10"
	result = ray.get(
...
def test_AlignmentStatistics():
	flagstat_file = "test/public/unit/omnition-dbg/files/feature_aware_flagstat.txt"
	flagstat = mod.parse_flagstat(flagstat_file)
