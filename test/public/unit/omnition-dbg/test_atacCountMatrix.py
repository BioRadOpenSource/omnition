...
spec = importlib.util.spec_from_file_location("dedup", "bin/publicAtacCountMatrix.py")
...
def test_frip_is_not_zero():
    bam_file = "test/public/unit/omnition-dbg/files/DemoAtacNormal_S1.final.bam"
    peak_bed = "test/public/unit/omnition-dbg/files/DemoAtacNormal_S1.fixedwidthpeaks.bed"
    test_allowlist = "test/public/unit/omnition-dbg/files/DemoAtacNormal_S1.QCstats.csv"
