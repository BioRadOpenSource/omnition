...
spec = importlib.util.spec_from_file_location("merging", "bin/publicCoreCorrectCellBarcodes.py")
...
@pytest.fixture
def constants():
    pytest.filtered_bead_file = "test/public/unit/omnition-core/files/test_publicCoreCorrectCellBarcodes_filtered_bead_list.csv"
    pytest.barcode_translate_file = "test/public/unit/omnition-core/files/test_publicCoreCorrectCellBarcodes_barcode_translate.tsv"
