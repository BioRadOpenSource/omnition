...
spec = importlib.util.spec_from_file_location("correcting", "bin/publicRnaCorrectEdges.py")
...
@pytest.fixture
def constants():
    pytest.edge_file = "test/public/unit/omnition-core/files/F39-Rep1_S4_edges.tsv"
