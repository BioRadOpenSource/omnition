...
@pytest.fixture
def constants():
    pytest.readcounts_file = "test/public/unit/omnition-core/files/test_atacSplitFastq_readcounts.tsv"
    pytest.read1_file = "test/public/unit/omnition-core/files/test_atacSplitFastq_R1_001.complete_debarcoded.fastq.gz"
