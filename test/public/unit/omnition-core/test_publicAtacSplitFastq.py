...
spec = importlib.util.spec_from_file_location("split", "bin/publicAtacSplitFastq.py")
...
@pytest.fixture
def constants():
    pytest.readcounts_file = "test/public/unit/omnition-core/files/test_publicAtacSplitFastq_readcounts.tsv"
    pytest.read1_file = "test/public/unit/omnition-core/files/test_publicAtacSplitFastq_R1_001.complete_debarcoded.fastq.gz"
