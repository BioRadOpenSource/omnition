...
spec = importlib.util.spec_from_file_location("merging", "bin/publicRnaMergeBeads.py")
...
@pytest.fixture
def constants():
    pytest.edge_file = "test/public/unit/omnition-core/files/DemoRnaMerge_S1_edges.tsv"
    pytest.large_edge_file = "test/public/unit/omnition-core/files/F39-Rep1_S4_edges.tsv"
    pytest.small_edge_file = "test/public/unit/omnition-core/files/test_edges.tsv"
    pytest.bead_file = "test/public/unit/omnition-core/files/test_bead_file.tsv"
