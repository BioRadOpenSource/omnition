...
process MAKE_COUNT_MATRIX {
    ...
    publishDir "${params.options.resultsDir}/${sampleId}/${params.options.assay}/cellFilter",
    ...
    """
    publicAtacCountMatrix.py -b ${bam} -w ${data} -p ${bed} -c ${task.cpus} -s ${sampleId} -o ./ ${mixedcheck}
