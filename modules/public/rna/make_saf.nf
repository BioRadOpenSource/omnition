...
process MAKE_SAF {
    ...
    outputs=("annotation.saf" "gene_symbols.txt")
    ...
    param_names=("workflow.manifest.version" "gtf" "index"
    "params.options.reference.directory")

    parameters=("${workflow.manifest.version}" "${gtf}" "${index}"
    "${params.options.reference.directory}")
    ...
    do
        ...
        check_params "MAKE_SAF" "\$param_name" "\$parameter"
    done
    """
}
