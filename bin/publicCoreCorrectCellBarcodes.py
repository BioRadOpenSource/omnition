...
def main(filtered_bead_file, barcode_translate_file, sample_id):
    ...
    full_barcode_translate.write_csv(f"{sample_id}_barcodeTranslate.tsv", separator=",")
...
def read_barcode_translate(file):
    ...
    """
    barcode_df = pl.read_csv(file, separator=",", has_header=True)
    return barcode_df
...
def format_bead_list(
    ...
    """
    bead_list = bead_list.with_columns(
